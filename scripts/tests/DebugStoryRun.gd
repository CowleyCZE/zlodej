...
func _init():
	...
	var event_bus_script = load("res://scripts/autoload/EventBus.gd")
	var game_manager_script = load("res://scripts/autoload/GameManager.gd")
	var mission_data_script = load("res://scripts/resources/MissionData.gd")
	...
	var story_manager = story_script.new()
